  ...
  void performLayout() {
    ...
    if (child != null) {
      ...
      if (child is RenderShiftedBox &&
        ...
        this.preferredLayoutSize = childLayout.preferredLayoutSize;
        this.maximumLayoutSize = childLayout.maximumLayoutSize;
        this.minimumLayoutSize = childLayout.minimumLayoutSize;
