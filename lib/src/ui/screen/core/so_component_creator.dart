...
import '../../component/co_gauge_widget.dart';
...
class SoComponentCreator implements IComponentCreator {
  ...
  Map<String, ComponentWidgetBuilder> standardComponents = {
    ...
    'RadioButton': (ComponentModel componentModel) => CoRadioButtonWidget(
        componentModel: componentModel as SelectableComponentModel),
    'Chart': (ComponentModel componentModel) => CoChartWidget(
          componentModel: componentModel as ChartComponentModel,
        ),
    'Gauge': (ComponentModel componentModel) => CoGaugeWidget(
          componentModel: componentModel as GaugeComponentModel,
        ),
  };
